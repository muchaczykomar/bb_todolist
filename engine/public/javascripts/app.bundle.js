...
"use strict";
/* WEBPACK VAR INJECTION */(function(_) {/* harmony import */ var __WEBPACK_IMPORTED_MODULE_0_backbone_marionette__ = __webpack_require__(0);
...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_1__formView__ = __webpack_require__(6);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_2__toDoView__ = __webpack_require__(8);
...
var MainLayout = __WEBPACK_IMPORTED_MODULE_0_backbone_marionette___default.a.View.extend({
    el: '#main',
    template: _.template('<div id="form-region">        </div>        <div id="todo-region">        </div>        <button id="btn-add">Remove</button>'),
    regions: {
        formRegion: {
            el: '#form-region'
        },
    ...
    toDoView: null,
    initialize: function initialize() {
        this.formView = new __WEBPACK_IMPORTED_MODULE_1__formView__["a" /* default */]();
        this.toDoView = new __WEBPACK_IMPORTED_MODULE_2__toDoView__["a" /* default */]();
    },
    onRender: function onRender() {
        this.showChildView('formRegion', this.formView);
        this.showChildView('tableRegion', this.toDoView);
    },
    onChildviewAddNewElement: function onChildviewAddNewElement(params) {
...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_1_backbone_marionette__ = __webpack_require__(0);
...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_2__views_layoutView__ = __webpack_require__(4);
...
var App = __WEBPACK_IMPORTED_MODULE_1_backbone_marionette___default.a.Application.extend({
    region: '#main',
...
var myView = new __WEBPACK_IMPORTED_MODULE_2__views_layoutView__["a" /* default */]();
var app = new App();
app.start();
myView.render();
...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_1_backbone_marionette__ = __webpack_require__(0);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_1_backbone_marionette___default = __webpack_require__.n(__WEBPACK_IMPORTED_MODULE_1_backbone_marionette__);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_2__templates_form_html__ = __webpack_require__(10);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_2__templates_form_html___default = __webpack_require__.n(__WEBPACK_IMPORTED_MODULE_2__templates_form_html__);




var FormView = __WEBPACK_IMPORTED_MODULE_1_backbone_marionette___default.a.View.extend({
    template: __WEBPACK_IMPORTED_MODULE_2__templates_form_html___default.a,
    ui: {
        name: '#id_name',
        note: '#id_note',
        addBtn: '#btn-add'
    ...
    add: function add() {
        var name = this.getUI('name')[0].value;
        var note = this.getUI('note')[0].value;
        name += '-radek';
...
/* harmony default export */ __webpack_exports__["a"] = (FormView);
...
var RowView = __WEBPACK_IMPORTED_MODULE_0_backbone_marionette___default.a.View.extend({
...
/* harmony default export */ __webpack_exports__["a"] = (RowView);
/* WEBPACK VAR INJECTION */}.call(__webpack_exports__, __webpack_require__(2)))
...
"use strict";
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_0_backbone_marionette__ = __webpack_require__(0);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_0_backbone_marionette___default = __webpack_require__.n(__WEBPACK_IMPORTED_MODULE_0_backbone_marionette__);
...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_2_backbone_radio__ = __webpack_require__(3);
...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_3__rowView__ = __webpack_require__(7);





var ToDoView = __WEBPACK_IMPORTED_MODULE_0_backbone_marionette___default.a.CollectionView.extend({
    // template: _.template('<div>todo</div>')
    collection: new __WEBPACK_IMPORTED_MODULE_1_backbone___default.a.Collection(),
    lastID: 0,
    childView: function childView(item) {
        item.set('id', this.lastID++);
        return __WEBPACK_IMPORTED_MODULE_3__rowView__["a" /* default */];
    },
    initialize: function initialize() {
        var Radio = Radio;
        this.radio = Radio.channel('todo');
    ...
    addElement: function addElement(params) {
        this.collection.add(params);
        console.log('odebralem', params);
    }
});

/* harmony default export */ __webpack_exports__["a"] = (ToDoView);
...
with(obj||{}){
__p+='<label for="id_name">Put in your name:</label>\r\n<input type="text" name="text" id="id_name"/>\r\n<label for="id_note">Put here your note:</label>\r\n<input type="text" name="textarea" id="id_note"/>\r\n\r\n<button id="btn-add">Add Note</button>';
}
return __p;
};
